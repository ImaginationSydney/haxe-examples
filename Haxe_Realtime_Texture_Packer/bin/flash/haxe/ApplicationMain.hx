...
class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			build: "109",
			company: "P.J.Shand",
			file: "HaxeRealtimeTexturePacker",
			fps: 60,
			name: "Haxe_Realtime_Texture_Packer",
			orientation: "",
			packageName: "net.peteshand.realtimeTexturePacker.HaxeRealtimeTexturePacker",
			version: "1.0.0",
			windows: [
				
				{
					...
					resizable: true,
					stencilBuffer: true,
					title: "Haxe_Realtime_Texture_Packer",
					vsync: false,
					width: 500,
					x: null,
					y: null
...
@:keep class DocumentClass extends net.peteshand.realtimeTexturePacker.Main {}
