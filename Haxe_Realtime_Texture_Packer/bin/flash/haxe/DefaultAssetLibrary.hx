...
@:keep @:bind #if display private #end class __ASSET__swf_assets_swf extends flash.utils.ByteArray { }
...
@:keep @:bind #if display private #end class __ASSET__libraries_assets_assets_dat extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__libraries_assets_json extends flash.utils.ByteArray { }
...
@:image("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets/27.png") #if display private #end class __ASSET__libraries_assets_27_png extends lime.graphics.Image {}
@:image("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets/12.png") #if display private #end class __ASSET__libraries_assets_12_png extends lime.graphics.Image {}
@:image("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets/54.png") #if display private #end class __ASSET__libraries_assets_54_png extends lime.graphics.Image {}
@:image("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets/39.png") #if display private #end class __ASSET__libraries_assets_39_png extends lime.graphics.Image {}
@:image("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets/24.png") #if display private #end class __ASSET__libraries_assets_24_png extends lime.graphics.Image {}
@:image("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets/9.png") #if display private #end class __ASSET__libraries_assets_9_png extends lime.graphics.Image {}
@:image("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets/51.png") #if display private #end class __ASSET__libraries_assets_51_png extends lime.graphics.Image {}
@:image("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets/36.png") #if display private #end class __ASSET__libraries_assets_36_png extends lime.graphics.Image {}
@:image("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets/21.png") #if display private #end class __ASSET__libraries_assets_21_png extends lime.graphics.Image {}
@:image("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets/6.png") #if display private #end class __ASSET__libraries_assets_6_png extends lime.graphics.Image {}
@:image("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets/48.png") #if display private #end class __ASSET__libraries_assets_48_png extends lime.graphics.Image {}
@:image("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets/33.png") #if display private #end class __ASSET__libraries_assets_33_png extends lime.graphics.Image {}
@:image("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets/18.png") #if display private #end class __ASSET__libraries_assets_18_png extends lime.graphics.Image {}
@:image("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets/60.png") #if display private #end class __ASSET__libraries_assets_60_png extends lime.graphics.Image {}
@:image("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets/3.png") #if display private #end class __ASSET__libraries_assets_3_png extends lime.graphics.Image {}
@:image("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets/45.png") #if display private #end class __ASSET__libraries_assets_45_png extends lime.graphics.Image {}
@:image("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets/30.png") #if display private #end class __ASSET__libraries_assets_30_png extends lime.graphics.Image {}
@:image("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets/15.png") #if display private #end class __ASSET__libraries_assets_15_png extends lime.graphics.Image {}
@:image("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets/57.png") #if display private #end class __ASSET__libraries_assets_57_png extends lime.graphics.Image {}
@:image("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets/42.png") #if display private #end class __ASSET__libraries_assets_42_png extends lime.graphics.Image {}
@:file("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets/assets.dat") #if display private #end class __ASSET__libraries_assets_assets_dat extends lime.utils.ByteArray {}
@:file("C:/_projects/HaxeExamples/haxe-examples/Haxe_Realtime_Texture_Packer/bin/flash/obj/libraries/assets.json") #if display private #end class __ASSET__libraries_assets_json extends lime.utils.ByteArray {}
