...
@:file("C:/_projects/Demos/Haxe_Swf_Assets/bin/html5/obj/libraries/assets/assets.dat") #if display private #end class __ASSET__libraries_assets_assets_dat extends lime.utils.ByteArray {}
@:file("C:/_projects/Demos/Haxe_Swf_Assets/bin/html5/obj/libraries/assets.json") #if display private #end class __ASSET__libraries_assets_json extends lime.utils.ByteArray {}
