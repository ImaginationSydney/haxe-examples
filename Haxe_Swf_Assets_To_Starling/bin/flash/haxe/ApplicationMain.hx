...
class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			fps: 60,
			name: "Haxe_Swf_Assets_To_Starling",
			orientation: "",
			packageName: "net.peteshand.swfAssetsToStarling.HaxeSwfAssetsToStarling",
			version: "1.0.0",
			windows: [
				
				{
					...
					resizable: true,
					stencilBuffer: true,
					title: "Haxe_Swf_Assets_To_Starling",
					vsync: false,
					width: 500,
					x: null,
					y: null
	...
	public static function start ():Void {
		...
		var hasMain = false;
		var entryPoint = Type.resolveClass ("net.peteshand.swfAssetsToStarling.Main");
...
@:keep class DocumentClass extends net.peteshand.swfAssetsToStarling.Main {}
